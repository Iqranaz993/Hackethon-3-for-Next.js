                ...
                <div className="h-full border-2 border-gray-200 border-opacity-60 overflow-hidden">
                  ...
                  <div className="px-4 md:px-[30px] flex justify-between">
                    ...
                    <div className="flex gap-[6px] md:gap-[10px] text-[white] text-[16px] md:text-[18px]">
                      <MdThumbUpOffAlt className="text-[#FF9F0D] hover:text-[#FF9F0D] cursor-pointer" />
                      <LiaCommentDotsSolid className="text-[#FF9F0D] hover:text-[white] cursor-pointer" />
              ...
              <div className="p-4 w-[300px] sm:w-[300px] h-auto sm:h-[379px]">
                <div className="h-full border-2 border-gray-200 border-opacity-60 overflow-hidden">
                  ...
                  <div className="px-4 md:px-[30px] flex justify-between">
                    ...
                    <div className="flex gap-[6px] md:gap-[10px] text-whitetext text-[16px] md:text-[18px]">
                      <MdThumbUpOffAlt className="text-[white] hover:text-[#FF9F0D] cursor-pointer" />
                      <LiaCommentDotsSolid className="text-[#FF9F0D] hover:text-bordercoloryello cursor-pointer" />
                      <LuShare2 className="text-[white] hover:text-[#FF9F0D] cursor-pointer" />
                    </div>
                  </div>
                </div>
