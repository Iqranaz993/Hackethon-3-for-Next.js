    ...
    <footer className="bg-primary text-[white]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center px-[135px] py-[50px]">
          ...
          <div className="flex md:mt-0 mt-[20px]">
            ...
            />
            <button className="text-[#FF9F0D] bg-white py-[5px] md:py-[10px] px-[10px] md:px-[20px] bg-[white]">Subscribe Now</button>
          </div>
      ...
      <div className="mx-auto w-full max-w-screen-xl ">
        ...
        <div className=" px-4 py-6 bg-[#FF9F0D] w-full  md:flex md:items-center md:justify-between">
          <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
            © 2023 Flowbite™. All Rights
            Reserved.
          </span>

          <div className="flex justify-center gap-[14px] ">
            <div className="bg-[white] w-[36px] h-[34px] flex justify-center items-center rounded text-primary"><a href="https://www.facebook.com/iqranaz993/"><FaFacebookF /></a></div>
            <div className="bg-[white] w-[36px] h-[34px] flex justify-center items-center rounded text-primary"><FaTwitter /></div>
            <div className="bg-[white] w-[36px] h-[34px] flex justify-center items-center rounded text-primary">< FaInstagram/></div>
            <div className="bg-[white] w-[36px] h-[34px] flex justify-center items-center rounded text-primary"><FaYoutube /></div>
            <div className="bg-[white] w-[36px] h-[34px] flex justify-center items-center rounded text-primary"><FaPinterest /></div>
          </div>
