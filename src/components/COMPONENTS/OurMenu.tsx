...
import main from "../../../public/MainMenu.png"
 const ourdata = [
  {
    id:0,
    title: "Lettuce Leaf",
...
const OurMenu = () => {
  return (
    <div className="mt-[100px] text-[white]">
      ...
      <ul className="flex flex-wrap justify-center text-[white] gap-[10px] md:gap-[30px] lg:gap-[50px] mt-[10px] md:mt-[20px]">
        <li className="text-[12px] md:text-[14px] lg:text-[15px] text-[white] hover:text-[#FF9F0D] text-bold cursor-pointer leading-[28px]">Breakfast</li>
        <li className="text-[12px] md:text-[14px] lg:text-[15px] text-[white] hover:text-[#FF9F0D] text-bold cursor-pointer leading-[28px]">Lunch</li>
        <li className="text-[12px] md:text-[14px] lg:text-[15px] text-[white] hover:text-[#FF9F0D] text-bold cursor-pointer leading-[28px]"> Dinner</li>
        <li className="text-[12px] md:text-[14px] lg:text-[15px] text-[white] hover:text-[#FF9F0D] text-bold cursor-pointer leading-[28px]"> Desert </li>
        <li className="text-[12px] md:text-[14px] lg:text-[15px] text-[white] hover:text-[#FF9F0D] text-bold cursor-pointer leading-[28px]"> Drink</li>
        <li className="text-[12px] md:text-[14px] lg:text-[15px] text-[white] hover:text-[#FF9F0D] text-bold cursor-pointer leading-[28px]">Snack</li>
        <li className="text-[12px] md:text-[14px] lg:text-[15px] text-[white] hover:text-[#FF9F0D] text-bold cursor-pointer leading-[28px]">Soups</li>
      </ul>
